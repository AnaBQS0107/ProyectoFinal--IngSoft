...
<div class="container">
    ...
    if (isset($_SESSION['user'])) {
        echo "<p style='color: blue;'>Bienvenido, " . htmlspecialchars($_SESSION['user']['Nombre']) . "! Al ser tu primer ingreso debes cambiar la contraseña</p>";
    } else {
        echo "<p style='color: red;'>No estás logueado. Por favor, inicia sesión.</p>";
    }
    ?>
    <form action="../Controlador/cambio.php" method="POST">
