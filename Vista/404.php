    ...
    <div class="container">
        <div class="left-section">
            <div class="inner-content">
                ...
                <p class="subheading">Página no encontrada, pero no te preocupes con PassWize siempre encontrarás el
                    camino para volver a casa.</p>
                <br>
                <center>
                    <button type="button" class="btn_volver" onclick="location.href='../Vista/Inicio.php'">Volver al
                        comienzo</button>
                </center>
            </div>
        </div>
